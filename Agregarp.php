<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $crud->createhabitantes($nombre, $apellido, $telefono, $id_apartamento);
  }
?>
...
<body>
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
		    ...
		    <input type="text" name="telef" id="telef" class='form-control' maxlength="12" required >
		</div>
		<div class="col-md-6">
		    <label style="padding-top: 10px;">ID Apartamento:</label>
		    <input type="number" name="id_apto" id="id_apto" class='form-control' maxlength="15" required>
		</div>
		<div class="">
